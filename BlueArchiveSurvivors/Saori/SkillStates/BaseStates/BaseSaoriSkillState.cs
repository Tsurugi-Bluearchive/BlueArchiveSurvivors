...
{
    public abstract class BaseSaoriSkillState : BaseSkillState
    {
        /// <summary>
        /// Cached SchoolgirlCharacterMain
        /// </summary>
        public  SaoriCharacterMain SaoriMain;
        ...
        {
            base.OnEnter();
            SaoriMain = (SaoriCharacterMain)EntityStateMachine.FindByCustomName(gameObject, "Body").state;
        }
    }
}
