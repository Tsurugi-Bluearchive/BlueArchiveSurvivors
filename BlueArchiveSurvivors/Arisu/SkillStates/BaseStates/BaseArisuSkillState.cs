...
{
    public abstract class BaseArisuSkillState : BaseSkillState
    {
        /// <summary>
        /// Cached SchoolgirlCharacterMain
        /// </summary>
        public  ArisuCharacterMain ArisuMain;
        ...
        {
            base.OnEnter();
            ArisuMain = (ArisuCharacterMain)EntityStateMachine.FindByCustomName(gameObject, "Body").state;
        }
    }
}
