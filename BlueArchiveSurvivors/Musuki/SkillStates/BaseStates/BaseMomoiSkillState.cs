...
namespace BAMod.Mutsuki.SkillStates.BaseStates
{
    public abstract class BaseMutsukiSkillState : BaseSkillState
    {
        /// <summary>
        /// Cached SchoolgirlCharacterMain
        /// </summary>
        public  MutsukiCharacterMain MutsukiMain;
        ...
        {
            base.OnEnter();
            MutsukiMain = (MutsukiCharacterMain)EntityStateMachine.FindByCustomName(gameObject, "Body").state;
        }
    }
}
