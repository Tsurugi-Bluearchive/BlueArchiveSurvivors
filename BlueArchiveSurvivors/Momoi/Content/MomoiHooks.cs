...
namespace BAMod.Momoi.Content
{
    static class MomoiHooks
    {
        ...
        {
            if (sender.HasBuff(MomoiBuffs.MomoiUltShield))
            {
        ...
        private static void HealthComponent_TakeDamage(On.RoR2.HealthComponent.orig_TakeDamage orig, HealthComponent self, DamageInfo damageInfo)
        {
            ...
            if (self.body && damageInfo.HasModdedDamageType(MomoiCustomDamageTypes.MomoiIgnite))
            {
            ...
            if (self.body && damageInfo.HasModdedDamageType(MomoiCustomDamageTypes.MomoiFlameGrenade))
            {
                InflictDotInfo dotInfo = new InflictDotInfo()
                {
                    attackerObject = damageInfo.attacker,
            ...
            if (self.body && damageInfo.HasModdedDamageType(MomoiCustomDamageTypes.MomoiDoubleIgnite))
            {
