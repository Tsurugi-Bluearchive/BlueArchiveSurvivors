...
{
    public abstract class BaseMomoiSkillState : BaseSkillState
    {
        /// <summary>
        /// Cached SchoolgirlCharacterMain
        /// </summary>
        public  MomoiCharacterMain MomoiMain;
        ...
        {
            base.OnEnter();
            MomoiMain = (MomoiCharacterMain)EntityStateMachine.FindByCustomName(gameObject, "Body").state;
        }
    }
}
