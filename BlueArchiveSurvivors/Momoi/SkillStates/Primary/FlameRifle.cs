...
namespace BAMod.Momoi.SkillStates.Primary
{
    internal class FlameRifle : BaseMomoiSkillState
    {
                ...
                if (!MomoiMain.AutoShotty)
                {
                    ...
                    foreach (var p in pelletVectors)
                    {
                        BulletAttack bullet = new BulletAttack
                        {
                            ...
                            bulletCount = 1U,
                            procCoefficient = 1f,
                            damage = base.characterBody.damage * MomoiStaticValues.burstDamage,
                            force = 3,
                        ...
                        bullet.AddModdedDamageType(MomoiCustomDamageTypes.MomoiIgnite);
                        bullet.Fire();
                        tick -= 0.05f;
                        FiredAmount += 1;
                    }
